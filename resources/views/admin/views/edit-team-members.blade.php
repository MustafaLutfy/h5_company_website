...
<div class="flex items-center justify-center h-[80%] my-[5%] px-4 pt-6 md:ml-[14%]">
    ...
    <div class="p-4 mb-4 md:w-[60%] w-[90%] bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
        <h3 class="mb-4 text-xl font-semibold dark:text-white">Edit Team Member</h3>
            ...
            <div class="grid grid-cols-1 gap-6">  
                ...
                <div class="sm:col-span-6">  
                    ...
                    <input type="text" name="name_en" id="name_en"   
                           ...
                           placeholder="Member Name (English)" required>  
                </div>  
                ...
                <div class="sm:col-span-6">  
                    ...
                    <textarea name="description_en" id="description_en" rows="4"   
                              class="block max-h-56 p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"   
                              placeholder="Write a short description in English...">{{ old('description_en', $teamMember->description_en) }}</textarea>  
                </div>  
        
                <!-- Description (Arabic) -->  
                <div class="sm:col-span-6">  
                    <label for="description_ar" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description (Arabic)</label>  
                    <textarea name="description_ar" id="description_ar" rows="4"   
                              class="block max-h-56 p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"   
                              placeholder="Write a short description in Arabic...">{{ old('description_ar', $teamMember->description_ar) }}</textarea>  
                </div>  
                ...
                <div class="sm:col-span-6">  
                    ...
                    @if($teamMember->image)  
                        <div class="mt-4">  
                            ...
                            <img src="{{ asset('team_members/' . $teamMember->image) }}"   
