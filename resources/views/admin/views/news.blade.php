                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                    <thead class="bg-gray-100 dark:bg-gray-700">
                        <tr>
                            ...
                            <th scope="col" class="p-4 text-xs font-medium text-right pr-10 text-gray-500 uppercase dark:text-gray-400">
                                Actions
                            </th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                       ...
                       <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <td class="p-4 flex h-16 space-x-2 whitespace-nowrap">
                            ...
                            <form action="{{route('post.delete', $post->id)}}" method="POST" class="h-full ml-auto">
                                @method('DELETE')
                                @csrf
