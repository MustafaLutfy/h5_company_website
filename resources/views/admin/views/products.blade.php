                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                    <thead class="bg-gray-100 dark:bg-gray-700">
                        <tr>
                            ...
                            <th scope="col" class="p-4 text-xs font-medium w-16 text-left text-gray-500 uppercase dark:text-gray-400">
                                Priority
                            </th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                       ...
                       <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                            <div class="text-base text-center font-semibold text-gray-900 dark:text-white">{{$product->product_order}}</div>                        </td>
                        <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                        ...
                        <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{{$product->original_price}}</td>
                        ...
                        <td class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-gray-400">{{$product->store->name}}</td>
                        ...
                        <td class="p-4 flex h-16 space-x-2 whitespace-nowrap">
                            ...
                            <form action="{{route('product.delete', $product->id)}}" method="POST" class="h-full">
                                @method('DELETE')
                                @csrf
                                <button type="submit"class="w-24 h-full justify-center text-red-600 inline-flex items-center hover:text-white border border-red-600 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">
                                    <svg aria-hidden="true" class="w-8 h-8 mr-1 -ml-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd"></path></svg>
                                    Delete
                                </button>
                            </form>
    ...
    <form action="{{route('product.edit', $product->id)}}" method="POST">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="original_price" id="original_price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{$product->original_price}}" required="">
            </div>
            <div>
                <label for="product_order" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Product Order</label>
                <input type="text" name="product_order" id="product_order" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{$product->product_order}}" required="">
            </div>
            <div>
                <label for="store_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Store</label>
                <select id="store_id" name="store_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter description here">{{$product->description}}</textarea>
            </div>
            <div>
                <label for="description_ar" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Arabic Description</label>
                <textarea id="description_ar" name="description_ar" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter description here">{{$product->description_ar}}</textarea>
            </div>
            <div>
