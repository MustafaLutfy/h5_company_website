...
<head>
    ...
    <meta name="admin-news" content="here you can see all news" />
    <link rel="icon" href="{{ url('images/h5-logo.svg') }}">
</head>

<div
    class="xl:ml-[18%] lg:ml-[24%] md:ml-[28%] p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
    <div class="w-full mb-1 ">
        <div class="mb-4">
            ...
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Team Members</h1>
        </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                    <thead class="bg-gray-100 dark:bg-gray-700">
                        <tr>
                            ...
                            <th scope="col"
                                class="p-4 text-xs font-medium text-left pl-20 pr-10 text-gray-500 uppercase dark:text-gray-400">
                                Actions
                            </th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        @foreach ($teamMembers as $member)
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                <td class="w-4 p-4">
                                    <div class="flex items-center">
                                        <input id="checkbox-{{ $member->id }}" aria-describedby="checkbox-1"
                                            type="checkbox"
                                            class="w-4 h-4 border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:focus:ring-primary-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600">
                                        <label for="checkbox-{{ $member->id }}" class="sr-only">checkbox</label>
                                    </div>
                                </td>
                                ...
                                <td class="p-4 text-sm font-medium text-gray-900 dark:text-white">{{ $member->role }}
                                </td>
                                <td class="p-4 text-sm font-medium text-gray-900 dark:text-white max-w-96">
                                ...
                                <td class="p-4 flex h-16 space-x-2 whitespace-nowrap">
                                    ...
                                    <a href="{{ route('team-members.edit', $member->id) }}">
                                        <button type="button"
                                            class="group w-24 h-full justify-center text-blue-600 inline-flex items-center hover:text-white border border-blue-600 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:border-blue-600 dark:text-blue-600 dark:hover:text-white dark:hover:bg-blue-600 dark:focus:ring-blue-900">
                                            <svg class="w-4 h-4 mr-1 -ml-1 fill-blue-600 group-hover:fill-white"
                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                                <path d="M5 18.08V19h.92l9.06-9.06l-.92-.92z" opacity="0.3" />
                                                <path
