              ...
              <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right" style="background-image: url('https://images.unsplash.com/photo-1422190441165-ec2956dc9ecc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1600&q=80');">
                  ...
                  <div class="container mx-auto">
                      <div class="flex flex-col w-full lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide">
                          <p class="text-black text-2xl my-4">H5 Store find what ever you dream of</p>
...
-->
  ...
  <section class="bg-gray-100 py-8">
    ...
    <div class="absolute blur-2xl w-20 h-[1000px] left-[70%] z-0 rounded-full bg-orange-300 rotate-45"></div>
    <div class="absolute blur-2xl w-20 h-[640px] left-[30%] z-0 rounded-full bg-purple-300 rotate-45"></div>
    <div class="absolute blur-2xl w-20 h-[80px] left-[40%] top-[140%] z-0 rounded-full bg-orange-400 rotate-45"></div>
    <div class="absolute blur-2xl w-20 h-[400px] left-[95%] top-[100%] z-0 rounded-full bg-purple-300 rotate-45"></div>
    <div class="absolute blur-2xl w-20 h-[400px] left-[0%] top-[100%] z-0 rounded-full bg-orange-300 rotate-45"></div>
      ...
      Store
          ...
          <div class="w-[400px] m-4 bg-white rounded-xl md:w-[400px] xl:w-[350px] p-6 z-10 flex flex-col">
            <a href="#">
                ...
                <p class="pt-1 text-gray-900">10,000IQD</p>
            </a>
          </div>
          <div class="w-[400px] m-4 bg-white rounded-xl md:w-[400px] xl:w-[350px] p-6 z-10 flex flex-col">
            <a href="#">
