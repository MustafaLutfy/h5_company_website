...
-->
  ...
  <section class="bg-gray-100 py-8">
    ...
    <div class="absolute blur-3xl w-20 h-[400px] left-[0%] top-[100%] z-0 rounded-full bg-orange-200 rotate-45"></div>
      ...
      <div class="container mx-auto flex justify-center items-center flex-wrap pt-4 pb-12">
      ...
      Store
          ...
          <div class="w-[400px] transition-all hover:-translate-y-2 shadow-lg m-4 bg-white rounded-xl md:w-[400px] xl:w-[350px] p-6 z-10 flex flex-col">
            <a href="#">
                <img class="border-2 rounded-lg " src="https://images.unsplash.com/photo-1551431009-a802eeec77b1?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&h=400&q=80">
                <div class="pt-3 flex items-center justify-between">
                    <p class="font-semibold w-[90%]">Product Name</p>
                  <svg class="h-6 w-6 fill-current text-gray-500 hover:text-black" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <path d="M21,7H7.462L5.91,3.586C5.748,3.229,5.392,3,5,3H2v2h2.356L9.09,15.414C9.252,15.771,9.608,16,10,16h8 c0.4,0,0.762-0.238,0.919-0.606l3-7c0.133-0.309,0.101-0.663-0.084-0.944C21.649,7.169,21.336,7,21,7z M17.341,14h-6.697L8.371,9 h11.112L17.341,14z" />
                    <circle cx="10.5" cy="18.5" r="1.5" />
                    <circle cx="17.5" cy="18.5" r="1.5" />
                </svg>
                </div>
                <p class="pt-4 text-gray-900">10,000IQD</p>
            </a>
          </div>
